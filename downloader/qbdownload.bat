...
git clone -b master https://github.com/qbcore-framework/bob74_ipl ./resources/[standalone]/bob74_ipl
git clone -b main https://github.com/qbcore-framework/safecracker ./resources/[standalone]/safecracker
git clone -b master https://github.com/citizenfx/screenshot-basic ./resources/[standalone]/screenshot-basic
git clone -b main https://github.com/qbcore-framework/progressbar ./resources/[standalone]/progressbar
git clone -b master https://github.com/qbcore-framework/interact-sound ./resources/[standalone]/interact-sound
git clone -b main https://github.com/qbcore-framework/mhacking ./resources/[standalone]/mhacking
git clone -b master https://github.com/qbcore-framework/connectqueue ./resources/[standalone]/connectqueue
git clone -b master https://github.com/qbcore-framework/dpemotes ./resources/[standalone]/dpemotes
git clone -b master https://github.com/qbcore-framework/PolyZone ./resources/[standalone]/PolyZone
git clone -b master https://github.com/qbcore-framework/LegacyFuel ./resources/[standalone]/LegacyFuel

echo [1m Cooling down (we dont want to spam github)...[0m
timeout 5 > NUL

git clone -b main https://github.com/AvarianKnight/pma-voice ./resources/[voice]/pma-voice
git clone -b main https://github.com/qbcore-framework/qb-radio ./resources/[voice]/qb-radio
git clone -b main https://github.com/qbcore-framework/hospital_map ./resources/[defaultmaps]/hospital_map
git clone -b main https://github.com/qbcore-framework/dealer_map ./resources/[defaultmaps]/dealer_map
git clone -b main https://github.com/qbcore-framework/prison_map ./resources/[defaultmaps]/[prison_map]
...
@RD /S /Q "%CURRENTDIR%\resources\[standalone]\bob74_ipl\.git"
@RD /S /Q "%CURRENTDIR%\resources\[standalone]\safecracker\.git"
@RD /S /Q "%CURRENTDIR%\resources\[standalone]\screenshot-basic\.git"
@RD /S /Q "%CURRENTDIR%\resources\[standalone]\progressbar\.git"
@RD /S /Q "%CURRENTDIR%\resources\[standalone]\interact-sound\.git"
@RD /S /Q "%CURRENTDIR%\resources\[standalone]\mhacking\.git"
@RD /S /Q "%CURRENTDIR%\resources\[standalone]\connectqueue\.git"
@RD /S /Q "%CURRENTDIR%\resources\[standalone]\dpemotes\.git"
@RD /S /Q "%CURRENTDIR%\resources\[standalone]\PolyZone\.git"
@RD /S /Q "%CURRENTDIR%\resources\[standalone]\LegacyFuel\.git"
@RD /S /Q "%CURRENTDIR%\resources\[voice]\pma-voice\.git"
@RD /S /Q "%CURRENTDIR%\resources\[voice]\qb-radio\.git"
@RD /S /Q "%CURRENTDIR%\resources\[defaultmaps]\hospital_map\.git"
@RD /S /Q "%CURRENTDIR%\resources\[defaultmaps]\dealer_map\.git"
@RD /S /Q "%CURRENTDIR%\resources\[defaultmaps]\[prison_map]\.git"
